    ...
    <header id="header" className="container mx-auto pt-16 md:pt-20 lg:pt-24 xl:pt-28 flex flex-col md:flex-row justify-between items-center">
      ...
      <div className="flex flex-col items-center w-full md:hidden">
        ...
        <div className="flex gap-4 justify-center">
          <a 
            href="/cv.pdf" 
            download="Thibo_Vonderlynck_CV.pdf"
            className="text-orange-500 px-5 py-2 border border-orange-500 rounded-full flex items-center gap-2 hover:bg-orange-500 hover:text-white transition-all duration-300 cursor-pointer text-sm"
          >
            Download CV
      ...
      <div className="hidden md:block md:w-1/2 md:px-0 text-left">
        ...
        <div className="pt-8 md:pt-10 lg:pt-12 xl:pt-14 flex gap-4 md:gap-5 lg:gap-6 justify-start">
          <a 
            href="/cv.pdf" 
            download="Thibo_Vonderlynck_CV.pdf"
            className="text-orange-500 px-5 md:px-5 lg:px-6 xl:px-7 py-2 md:py-2 lg:py-3 xl:py-3 border border-orange-500 rounded-full flex items-center gap-2 hover:bg-orange-500 hover:text-white transition-all duration-300 cursor-pointer text-sm md:text-sm lg:text-base xl:text-lg"
          >
            Download CV
