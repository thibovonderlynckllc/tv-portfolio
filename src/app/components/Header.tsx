...
const Header = () => {
  return (
    <header id="header" className="container mx-auto pt-16 md:pt-20 lg:pt-24 xl:pt-28 flex flex-col md:flex-row justify-between items-center">
      ...
      <div className="flex flex-col items-center w-full md:hidden">
        ...
        <div className="relative mb-8">
          ...
          <div className="absolute w-[280px] h-[280px] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
            <svg className="w-full h-full" viewBox="0 0 100 100">
              <circle cx="50" cy="50" r="49" fill="none" stroke="#f97316" strokeWidth="0.4" strokeDasharray="130 250" transform="rotate(-55, 50, 50)" />
            </svg>
          </div>
          <Image className="[filter:drop-shadow(0_0_200px_rgba(249,115,22,0.6))] relative z-10 rounded-full border-[0.5px] border-white/10 w-[250px] h-[250px]" src="/images/pfp.webp" alt="Profielfoto Thibo Vonderlynck Next.js Web Developer en UX Designer" width={400} height={400} />
        </div>
        ...
        <div className="flex gap-4 justify-center">
          <a href="/cv.pdf" download="Thibo_Vonderlynck_CV.pdf" className="text-orange-500 px-5 py-2 border border-orange-500 rounded-full flex items-center gap-2 hover:bg-orange-500 hover:text-white transition-all duration-300 cursor-pointer text-sm">
            Download CV
            <Download className="w-3 h-3" />
          </a>
          <button className="text-orange-500 gap-2">
            <a href="https://github.com/ThiboVonderlynck" target="_blank" rel="noopener noreferrer">
          ...
          <button className="text-orange-500 gap-2">
            <a href="https://www.linkedin.com/in/thibo-vonderlynck-9654a52bb/" target="_blank" rel="noopener noreferrer">
              <span className="w-8 h-8 flex items-center justify-center border border-orange-500 rounded-full hover:bg-orange-500 hover:text-white transition-all duration-300 cursor-pointer">
      ...
      <div className="hidden md:block pr-0 md:pr-8 lg:pr-12 xl:pr-15 relative">
        ...
        <Image className="[filter:drop-shadow(0_0_200px_rgba(249,115,22,0.6))] relative z-10 rounded-full border-[0.5px] border-white/10 w-[250px] h-[250px] md:w-[300px] md:h-[300px] lg:w-[350px] lg:h-[350px] xl:w-[400px] xl:h-[400px]" src="/images/pfp.webp" alt="Profielfoto Thibo Vonderlynck Next.js Web Developer en UX Designer" width={400} height={400} />
      </div>
    </header>
  );
};
